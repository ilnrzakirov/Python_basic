...
# , т.к. результат храним в тексте, отсортировали некорректно
...
# , sorted лишняя функция пока что =)
...
# , давайте попробуем создать список без цикла, применив list к games_result_dict.items() =)
#  После этого, применим в списку функцию для сортировки списка.
#  И далее используем цикл для вывода значение =)

# , далее, необходимо создать список списков из ключей и значений словаря games_result_dict.
