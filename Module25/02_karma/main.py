...
#  предлагаю создавать в этом месте классы KillError, DrunkError, CarCrashError, GluttonyError, DepressionError.
...
# , если убрать создание объектов классов ниже, то ошибки не будет.
...
while karma < 500:
    ...
    #  (KillError, DrunkError) - таким образом ловим 2 ошибки. Предлагаю ловить только те ошибки, что вызываем мы =)
